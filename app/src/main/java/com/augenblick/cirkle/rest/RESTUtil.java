package com.augenblick.cirkle.rest;

import com.augenblick.cirkle.connection.ConnectionUtil;
...
import com.augenblick.cirkle.response.HttpResponseResolver;
import com.augenblick.cirkle.response.UnauthorizedResponse;
import com.augenblick.cirkle.response.ValidationErrorResponse;
...
public class RESTUtil {
    ...
    public CirkleResponse delete(String path, Map<String, String> params) throws CirkleException {
        ...
        String serviceURL = ConnectionUtil.getServerConnectionString() + path + appendGetParams(params);;
    ...
    public CirkleResponse post(String path, Map<String, String> params) throws CirkleException {
        ...
        String serviceURL = ConnectionUtil.getServerConnectionString() + path;
